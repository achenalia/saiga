...
function Search() {
  ...
  return (
    <div className="flex items-center justify-center backdrop-blur-3xl bg-white/30 border-2 border-zinc-900 pt-8 pb-8 pl-8 pr-8 shadow-[8px_8px_0px_rgba(0,0,0,1)]">
